...
document.getElementById("btn-choose-color").onclick = () => {
    ...
    let mood = "Happy"; /*this should be a let, not a const mood*/
    ...
    //document.getElementById("color-message").innerHTML = "You choose " + color; /*somethign and adding it with something else is a k-catnation or whatever its spelt*/
